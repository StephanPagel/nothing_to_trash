...
const setProduct = () => {
    return (
      <form>
        ...
        <label>EUR</label>
        <input type="radio" name="priceOptions" id="priceOptionFixed" value="fixed" />
        <label>Festpreis</label>
        <input type="radio" name="priceOptions" id="priceOptionNegotiable" value="negotiable" />
        <label>VB</label>
        <input type="radio" name="priceOptions" id="priceOptionGiveAway" value="negotiable" />
        ...
        <input type="text" name="street" id="street" required placeholder="Straße/Nr." />
        <label>Name*</label>
        <input type="text" name="name" id="name" required placeholder="Name" />
        <label>Telefonnummer</label>
        <input type="number" name="phone" id="phone" required placeholder="Telefon" />
      </form>
    );
}
